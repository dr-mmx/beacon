...
import (
	...
	beaconmodule "beacon/x/beacon"
	beaconmodulekeeper "beacon/x/beacon/keeper"
	beaconmoduletypes "beacon/x/beacon/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "beacon/app/params"
	"beacon/docs"
)
...
func New(
	...
	*/
	...
	app.BeaconKeeper = *beaconmodulekeeper.NewKeeper(
		appCodec,
		keys[beaconmoduletypes.StoreKey],
		keys[beaconmoduletypes.MemStoreKey],
		app.GetSubspace(beaconmoduletypes.ModuleName),
	)
	beaconModule := beaconmodule.NewAppModule(appCodec, app.BeaconKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(beaconmoduletypes.ModuleName)
